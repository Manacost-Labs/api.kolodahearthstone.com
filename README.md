...
PostgreSQL shadow, нормализаторы статистики, миграции и эксплуатационные
проверки находятся в [`platform/`](platform/README.md). Таким образом API,
панель и центральный слой данных версионируются вместе.
