...
function panel_script_assets(string $action): array
{
    ...
    $sections = [
        'list' => ['/assets/table-controls.js?v=3', '/assets/media-preview.js?v=1'],
        'analytics' => ['/assets/table-controls.js?v=3', '/assets/parsing-reliability.js?v=10', '/assets/analytics.js?v=16'],
        'parsers' => ['/assets/parser-control-view.js?v=3', '/assets/parser-control.js?v=4'],
        'api_tokens' => ['/assets/table-controls.js?v=3', '/assets/token-controls.js?v=1'],
