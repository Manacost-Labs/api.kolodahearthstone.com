...
const fixture = {
    ...
    sections: [
        {id:'meta',label:'Мета и архетипы',enabled:true,sourceCount:3,sources:[
            {id:'hsguru-meta-standard',label:'HSGuru · Standard meta',health:'ok',rowsTotal:184,lastSuccessAt:new Date(Date.now()-18*60000).toISOString(),schedule:'каждые 2 часа',nextRunAt:new Date(Date.now()+42*60000).toISOString(),publicationChannel:'stable',canRunManually:true},
            {id:'hsguru-meta-wild',label:'HSGuru · Wild meta',health:'warning',rowsTotal:93,lastSuccessAt:new Date(Date.now()-9*3600000).toISOString(),lastError:'Источник вернул меньше архетипов после нового патча',schedule:'каждые 2 часа',nextRunAt:new Date(Date.now()+42*60000).toISOString(),publicationChannel:'stable baseline',canRunManually:true},
            {id:'hsreplay-archetypes',label:'HSReplay · архетипы',health:'ok',rowsTotal:341,lastSuccessAt:new Date(Date.now()-53*60000).toISOString(),schedule:'каждые 4 часа',nextRunAt:new Date(Date.now()+2*3600000).toISOString(),publicationChannel:'stable',canRunManually:true}
        ]},
        {id:'battlegrounds',label:'Поля сражений',enabled:true,sourceCount:2,sources:[
            {id:'bg-heroes',label:'Герои Battlegrounds',health:'ok',rowsTotal:105,lastSuccessAt:new Date(Date.now()-35*60000).toISOString(),schedule:'каждые 3 часа',nextRunAt:new Date(Date.now()+3600000).toISOString(),publicationChannel:'stable',canRunManually:true},
            {id:'bg-minions',label:'Существа Battlegrounds',health:'partial',rowsTotal:612,lastSuccessAt:new Date(Date.now()-5*3600000).toISOString(),lastError:'Часть рейтинговых срезов временно недоступна',schedule:'каждые 3 часа',nextRunAt:new Date(Date.now()+3600000).toISOString(),publicationChannel:'stable baseline',canRunManually:true}
        ]},
        {id:'arena',label:'Арена',enabled:false,sourceCount:1,sources:[
            {id:'arena-firestone',label:'Арена · Firestone',health:'ok',rowsTotal:288,lastSuccessAt:new Date(Date.now()-6*3600000).toISOString(),schedule:'каждые 6 часов',publicationChannel:'stable',canRunManually:true}
        ]}
    ],
