(() => {
    ...
    const detailLabels = {
        ...
        fetched_at: 'Получено нашим сборщиком', updated_at: 'Обновлено', state: 'Состояние', site: 'Сайт', cache: 'Режим данных',
        category: 'Категория', description: 'Описание', dataset: 'Набор', age: 'Давность сбора',
        upstream_age: 'Свежесть у источника', coverage: 'Компоненты сбора', evidence_note: 'Что подтверждено',
        components: 'Сведения о компонентах сбора', entities_total: 'Объектов в наборе', state_counts: 'Состояния сбора',
        state_summary: 'Состояния сбора',
        oldest_checked_at: 'Самая ранняя проверка', oldest_updated_at: 'Самое раннее получение данных',
        missing_checked_at_count: 'Без времени проверки', missing_updated_at_count: 'Без времени получения',
