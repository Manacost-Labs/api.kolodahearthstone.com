...
$panelQuickLinks = [
    ...
    'Аналитика и операции' => [
        ['Обзор и статистика', '/?action=analytics', 'Источники, архетипы, карты, Arena и Battlegrounds'],
        ['Источники данных', '/?action=parsers', 'Парсеры, свежесть, расписание и история запусков'],
    ],
    'Управление' => [
