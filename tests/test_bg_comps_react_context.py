...
class HsReplayCompsReactContextTest(unittest.TestCase):
    ...
    def test_reads_current_object_shaped_react_context_catalog(self) -> None:
        payload = {
            "comps": [
                {
                    "comp_id": 92,
                    "comp_name": "Elementals - Unbound Tempest",
                    "comp_slug": "elementals-unbound-tempest",
                    "comp_tier": 1,
                    "comp_difficulty": 1,
                    "comp_core_cards": [],
                    "comp_hidden": False,
                ...
                {
                    "comp_id": 76,
                    "comp_name": "Demons - APM Shop Buff",
                    "comp_slug": "demons-apm-shop-buff",
                    "comp_tier": 2,
                    "comp_difficulty": 3,
                    "comp_core_cards": [],
                    "comp_hidden": False,
                ...
                {
                    "comp_id": 14,
                    "comp_name": "Undead - Attack Scaling",
                    "comp_slug": "undead-attack-scaling",
                    "comp_tier": 3,
                    "comp_difficulty": 2,
                    "comp_core_cards": [],
                    "comp_hidden": False,
            ...
            "comps_admin_add_link": "/admin/battlegrounds/comps/add/",
        }
        html = (
            '<html><script type="application/json" id="react_context">'
            + json.dumps(payload)
        ...
        self.assertEqual([comp["comp_id"] for comp in comps], [92, 76, 14])
        self.assertEqual([comp["tier"] for comp in comps], ["S", "A", "B"])
        self.assertEqual(
            [comp["difficulty"] for comp in comps], ["Easy", "Hard", "Medium"]
        )
