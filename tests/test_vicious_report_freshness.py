...
def test_parse_latest_report_metadata_accepts_featured_report_container() -> None:
    html = """
    <article>
    ...
    <div class="featured-report">
      <a href="/vs-data-reaper-report-356/">Latest Data Reaper Report</a>
      <span class="entry-meta-date">August 28, 2026</span>
    </div>
    """
