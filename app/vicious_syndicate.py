...
def parse_latest_report_metadata(html: str) -> dict[str, str]:
    ...
    for link in soup.find_all("a", href=True):
        ...
        # The newest report is currently rendered in a featured container
        # rather than an <article>. Keep the date lookup scoped to the nearest
        # report container so unrelated page dates cannot be attached to it.
