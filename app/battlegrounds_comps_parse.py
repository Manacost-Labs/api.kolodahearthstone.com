...
def _comps_from_react_context(soup: Any) -> list[dict[str, Any]]:
    ...
    try:
        ...
        return []
    # Current pages serialize ``react_context`` as an object with the public
    # catalog under ``comps``; older pages emitted that list directly. Ignore
    # adjacent admin metadata and unknown shapes.
