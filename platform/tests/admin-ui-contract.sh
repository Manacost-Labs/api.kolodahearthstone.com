...
assert_contains partials/sidebar.php 'href="/\?action=api_tokens"' 'API token manager must be reachable from panel navigation'
assert_contains partials/sidebar.php 'href="/\?action=parsers"' 'parser operations workspace must be reachable from panel navigation'
...
assert_contains partials/catalog-controls.php 'data-table-density' 'large catalogue tables must provide a density control'
assert_contains partials/topbar.php 'data-command-open' 'shared panel shell must expose the quick navigation command'
assert_contains partials/command-palette.php 'data-command-palette' 'quick navigation dialog must be present'
assert_contains partials/table-navigation.php 'data-table-navigation' 'wide table navigation must use the shared component'
assert_contains partials/catalog-controls.php 'data-column-picker' 'catalogue tables must expose column visibility controls'
assert_contains index.php 'partials/table-navigation.php' 'catalogues must include the shared horizontal navigation'
